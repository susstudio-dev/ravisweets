 ...
 * insertion order, and the first row of the generated catalogue happened to
 * be Qubani ka Meetha. Nobody decided the shop's face; a row number did,
 * and the owner called it out ("it is not that primary"). (Qubani itself was
 * removed from the range on 2026-08-13 — the shop never made it; see
 * supabase/migrations/0022.)
 *
 ...
 * being unranked demotes, it never hides.
 */
