...
function picklesGroup(): Product[] {
  const items: MiniSku[] = [
    ...
    { slug: 'chicken-pickle', title: 'Chicken Pickle', image: pendingPhoto('2025/08/chicken-pickel.webp'), dietary_tags: ['non-veg'], builder_eligible: false, variantPaiseSmall: 25000, variantPaiseLarge: 100000, description: 'Boneless country-chicken simmered down with whole spices and sealed under oil. Travels three weeks unrefrigerated.' },
