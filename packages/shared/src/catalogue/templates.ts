...
export const TEMPLATES: Record<TemplateId, Template> = {
  essence: {
    ...
    startingUnits: 50,
    items: [
      { lineId: 'p_kaju_katli:v_kaju_250', productId: 'p_kaju_katli', variantId: 'v_kaju_250', qtyPerHamper: 1 },
      { lineId: 'p_badam_ki_jali:v_bkj_250', productId: 'p_badam_ki_jali', variantId: 'v_bkj_250', qtyPerHamper: 1 },
      { lineId: 'p_dry_almonds:v_alm_200', productId: 'p_dry_almonds', variantId: 'v_alm_200', qtyPerHamper: 1 },
    ],
    ribbon: 'cream',
    box: 'matte-cream',
    logoPrint: false,
  ...
  grande: {
    ...
    items: [
      ...
      { lineId: 'p_kaju_katli:v_kaju_500', productId: 'p_kaju_katli', variantId: 'v_kaju_500', qtyPerHamper: 1 },
      { lineId: 'p_badam_ki_jali:v_bkj_250', productId: 'p_badam_ki_jali', variantId: 'v_bkj_250', qtyPerHamper: 1 },
      { lineId: 'p_sheer_khurma:v_skh_500', productId: 'p_sheer_khurma', variantId: 'v_skh_500', qtyPerHamper: 1 },
      { lineId: 'p_dry_pistachios:v_pist_200', productId: 'p_dry_pistachios', variantId: 'v_pist_200', qtyPerHamper: 1 },
      { lineId: 'p_dry_almonds:v_alm_200', productId: 'p_dry_almonds', variantId: 'v_alm_200', qtyPerHamper: 1 },
      { lineId: 'p_saffron_pistachios:v_saff_100', productId: 'p_saffron_pistachios', variantId: 'v_saff_100', qtyPerHamper: 1 },
    ],
    ribbon: 'gold',
    box: 'silk-wrap',
    logoPrint: true,
